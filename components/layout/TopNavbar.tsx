...
export function TopNavbar({ lang, dict, user }: { lang: string, dict: any, user?: any }) {
    ...
    // Mock Notifications
    const notifications = [
        { id: 1, title: dict.Navbar?.notifications?.welcomeTitle || "Welcome to Promptda!", text: dict.Navbar?.notifications?.welcomeText || "Start exploring thousand of AI prompts.", time: "2m ago", read: false },
        { id: 2, title: dict.Navbar?.notifications?.updateTitle || "New Features Available", text: dict.Navbar?.notifications?.updateText || "Check out the new profile customization options.", time: "1h ago", read: true },
    ];
