...
export async function createPrompt(prevState: PromptState, formData: FormData): Promise<PromptState> {
    ...
    const validatedFields = PromptSchema.safeParse({
        ...
        tldr: formData.get('tldr') || undefined,
        noIndex: formData.get('noIndex') === 'on',
        noFollow: formData.get('noFollow') === 'on',
        lastUpdated: formData.get('lastUpdated') || undefined,
        promptCount: formData.get('promptCount') ? parseInt(formData.get('promptCount') as string) : undefined,
        promptType: formData.get('promptType') || undefined,
        authorName: formData.get('authorName') || undefined,
        authorBio: formData.get('authorBio') || undefined,
        beforeImage: formData.get('beforeImage') || undefined,
        afterImage: formData.get('afterImage') || undefined,
